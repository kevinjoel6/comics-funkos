...
const Footer = () => {
  return (
    <footer className="footer-02" id="us">
        <div className="container">
            ...
            <div className="col-md-4 col-lg-5">
              <div className="row">
                <div className="col-md-12 col-lg-8 mb-md-0 mb-4">
                  <h2 className="footer-heading"><a href="/#" className="logo">Marvel Studios</a></h2>
                  <div className="footer-m">
                    <img src="../data/img/logo/m-logo.png" alt=""/>
                  </div>
            ...
            <div className="col-md-8 col-lg-7">
              <div className="row">
                <div className="col-md-3 mb-md-0 mb-4 border-left">
                  <h2 className="footer-heading">Disney+</h2>
                ...
                <div className="col-md-3 mb-md-0 mb-4 border-left">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li><a href="/#" className="py-1 d-block">TikTok</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-9">
                  <p className="partner-name mb-0">
                    <a href="/#"><span className="ion-logo-ionic mr-2"></span>Company</a>
                  </p>
                </div>
          ...
          <div className="row mt-5">
            <div className="col-md-6 col-lg-8">
              ...
              Copyright &copy;<script>document.write(new Date().getFullYear());</script>2023 <a href='/#'>Marvel Inside Terms</a></p>
            </div>
